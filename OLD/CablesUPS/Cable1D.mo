...
extends Modelica.Mechanics.Translational.Interfaces.PartialCompliantWithRelativeStates;
  ...
  Modelica.Blocks.Interfaces.RealInput cableLength annotation (Placement(transformation(extent={{-120,50},{-80,90}})));
...
equation
  ...
  f = f_k + f_c;
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio = false)), Icon(coordinateSystem(initialScale = 0.1), graphics={  Line(points = {{-98, 0}, {-48, 0}}, color = {0, 127, 0}), Line(points = {{-12, -38}, {-12, 36}}, color = {0, 127, 0}, thickness = 1), Line(points = {{-12, -28}, {70, -28}, {70, 24}}, color = {0, 127, 0}), Line(points = {{70, 0}, {98, 0}}, color = {0, 127, 0}), Line(points = {{-12, 24}, {0, 24}, {6, 34}, {18, 14}, {30, 34}, {42, 14}, {54, 34}, {60, 24}, {70, 24}}, color = {0, 127, 0}), Rectangle(lineColor = {0, 127, 0}, fillColor = {192, 192, 192},
